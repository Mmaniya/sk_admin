...
function get_extra_fields() {
				...
				//$job_category[] = array('short_name'=>'P','value'=>'Professional');
				//$job_category[] = array('short_name'=>'SW','value'=>'Skilled Workers');
			...
			/*	$interested_sector[] = array('short_name'=>'A','value'=>'Agri');
				$interested_sector[] = array('short_name'=>'T','value'=>'Training');
				$interested_sector[] = array('short_name'=>'SG','value'=>'Self Help Group');
				$interested_sector[] = array('short_name'=>'Y','value'=>'Youth');
				$interested_sector[] = array('short_name'=>'M','value'=>'Mahila');*/
