...
<div id="layoutSidenav_content">
   <div class="container-fluid">
      <h2 class="mt-3">WARD DETAILS</h2>
      <ol class="breadcrumb mb-3">
         <a href="dashboard.php" class="breadcrumb-item">Home</a>
         <a href="ward.php" class="breadcrumb-item active">Ward Details</a>
      </ol>
      <div class="row">
         <div class="col-md-12">
            <div class="card mb-4">
               <div class="card-header"><i class="fa fa-chart-bar mr-1"></i>Ward List
...
<script type="text/javascript">
   $(document).ready(function(){
        paramData = {'act':'searchWard','filter_by':'all' }; 
        ajax({
            a:"wardajax",
            b:paramData,
            c:function(){},
        ...
        $('#inputvalue').keyup(function() {
            ...
            paramData = {'act':'searchWard','filter_by':filter_by }; 
                ajax({
                    a:"wardajax",
                    b:paramData,
                    c:function(){},
