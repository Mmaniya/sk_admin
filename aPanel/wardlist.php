...
<?php
   ...
   if(count($wardlist)>0 && $totalPages > 1){
   if($page > 1){
   $pageNo = $page - 1;
   ...
   ?>
    ...
    <thead class="bg-primary text-white">
        <tr>
            ...
            <th scope="col">MP Constant</th>
            <th scope="col">LG Constant </th>
    ...
    <tbody>
        <?php
            ...
            if( count($ListingParentCatListArr)>0) {
                ...
                $lgquery = array('tableName' => TBL_BJP_LG_CONST, 'fields' => array('*'),'condition' => array('id' => $value->lg_const_id.'-INT'),'showSql' => 'N', 'orderby' => 'id', 'sortby' => 'asc');
                $lgConstantData = Table::getData($lgquery); 
                $mandalquery = array('tableName' => TBL_BJP_MANDAL, 'fields' => array('*'),'condition' => array('id' => $value->mandal_id.'-INT'),'showSql' => 'N', 'orderby' => 'id', 'sortby' => 'asc');
        ...
        <tr>         
            ...
            <td><?php  echo $lgConstantData->lg_const_name; ?></td>
            <td><?php  echo $mandalData->mandal_name; ?></td>
            <td><?php  echo $value->ward_number; ?></td>
            <td><?php if($value->ward_category == 'P'){ echo 'PUBLIC'; } else if($value->ward_category == 'W') { echo 'WOMEN'; } else if($value->ward_category == 'R') { echo 'RESERVED'; }?></td>
            <td><?php if($value->ward_type == 'R'){ echo 'RURAL'; } else if($value->ward_type == 'C') { echo 'CITY'; } ?></td>
