...
if($serviceId>0) { 
	$param = array('tableName'=>TBL_EMPLOYEE_CATEGORY,'fields'=>array('*'),'condition'=>array('id'=>$serviceId.'-INT'));
...
?>
 ...
 <div class="card-box">
                                    <h4 class="m-t-0 header-title">Add Employee Category</h4>
                                   ...
                                   <form class="form-horizontal" role="form" id="service_category_form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-0 justify-content-end row">
											...
											<input type="hidden" name="act" value="addEditEmployeeCat"/>
