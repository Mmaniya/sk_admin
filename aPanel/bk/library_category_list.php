...
if($page > 1)
	...
	if(count($rsLibCategory)>0 && $totalPages > 1){
	if($page > 1){
		$pageNo = $page - 1;
...
<div class="col-md-4 d-none d-sm-block">Category Name</div>
<div class="col-md-5 d-none d-sm-block">Description</div>
...
<?php   $i = 0;
 ...
 if ($i % 2 == 1 && $i != count($rsLibCategory)) { $bg = ' rgba(0, 0, 0, 0.03)';   }
...
<div class="row right_border tb_row" style="background-color:<?php echo $bg; ?> ">
 <div class="col-md-1 d-none d-sm-block"><?php echo $key+1;?></div>
  <div class="col-md-4 colBorder"><strong><?php echo $val->category_name;?></strong></div>
  <div class="col-md-5 colBorder"><?php echo $val->category_desc; ?></div>
  <div class="col-md-2 colBorder"><a href="javascript:void(0)" class="a_tag" onclick="showAddEditLibraryCat(<?php echo $val->id; ?>)">[edit]</a> 
	 <a href="javascript:void(0)" class="a_tag" onclick="deleteCategory(<?php echo $val->id; ?>)">[delete]</a>
	 <a href="javascript:void(0)" class="a_tag" onclick="viewLibrary(<?php echo $val->id; ?>)">[view library]</a>
...
function showAddEditLibrary(id) {
	paramData = {'act':'add_edit_library','id':id};
	ajax({ 
		a:'library',
		b:$.param(paramData),
		c:function(){},
