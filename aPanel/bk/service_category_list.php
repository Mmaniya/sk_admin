...
<div class="col-md-2 d-none d-sm-block">Category Name</div>
...
<div class="row right_border tb_row" style="background-color:<?php echo $bg; ?> ">
 <div class="col-md-1 d-none d-sm-block"><?php echo $key+1;?></div>
  <div class="col-md-2 colBorder"><strong><?php echo $val->category_name.'&nbsp ('.$val->abbreviation.')';?></strong></div>
  <div class="col-md-6 colBorder"><?php echo $val->description; ?></div>
  <div class="col-md-3 colBorder"><a href="javascript:void(0)" class="a_tag" onclick="showAddEditServiceCat(<?php echo $val->id; ?>)">[edit]</a> 
