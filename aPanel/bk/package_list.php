...
if($page > 1)
	...
	if(count($rsPackage)>0 && $totalPages > 1){
	if($page > 1){
		$pageNo = $page - 1;
...
<div class="col-md-5 d-none d-sm-block">Package Name</div>
...
<div class="col-md-12 d-none d-sm-block"><hr></div>
 ...
 if ($i % 2 == 1 && $i != count($rsPackage)) { $bg = ' rgba(0, 0, 0, 0.03)';   }
...
<div class="row right_border tb_row" style="background-color:<?php echo $bg; ?>;padding-top:10px; padding-bottom:10px;">
 ...
 <div class="col-md-5"><?php echo $val->package_name; ?><br/><small><?php echo $val->package_desc; ?></small></div>
 <div class="col-md-3"><?php echo money($val->package_price,'$'); ?></div>
 <div class="col-md-3"><a href="javascript:void(0)" onclick="showAddEditForm(<?php echo $val->id; ?>)">[edit]</a>  
 <a href="javascript:void(0)" onclick="deletePackage(<?php echo $val->id; ?>)">[delete]</a> <br/>
 <a href="javascript:void(0)" onclick="view_services(<?php echo $val->id; ?>)">[view package]</a>
 </div>
  </div>
