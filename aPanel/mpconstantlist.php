...
<?php
   ...
   if(count($mpconstantlist)>0 && $totalPages > 1){
   if($page > 1){
   $pageNo = $page - 1;
...
<table class="table table-hover" style="border: 2px solid #eee;" >
   <thead class="bg-primary text-white">
      <tr>
         ...
         <th scope="col">MP Constituency No</th>
   ...
   <tbody>
      ...
      <tr>         
         ...
         <td><?php  echo $value->bjp_mp_const_no; ?></td>
         <td><?php  echo $value->bjp_mp_const_name; ?></td>
         <td><?php if($value->mp_const_category == 'P'){ echo 'PUBLIC'; } else if($value->mp_const_category == 'W') { echo 'WOMEN'; } else if($value->mp_const_category == 'R') { echo 'RESERVED'; }?></td>
