...
<div id="layoutSidenav_content">
   <div class="container-fluid">
      <h2 class="mt-3">MP CONSTITUENCY DETAILS</h2>
      <ol class="breadcrumb mb-3">
         <a href="dashboard.php" class="breadcrumb-item">Home</a>
         <a href="mpconstant.php" class="breadcrumb-item active">MP Constituency Details</a>
      </ol>
      <div class="row">
         <div class="col-md-12">
            <div class="card mb-4">
               <div class="card-header"><i class="fa fa-chart-bar mr-1"></i>MP Constituency List
