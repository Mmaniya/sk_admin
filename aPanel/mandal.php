...
<div id="layoutSidenav_content">
   <div class="container-fluid">
      <h2 class="mt-3">MANDAL DETAILS</h2>
      <ol class="breadcrumb mb-3">
         <a href="dashboard.php" class="breadcrumb-item">Home</a>
         <a href="mandal.php" class="breadcrumb-item active">Mandal Details</a>
      </ol>
      <div class="row">
         <div class="col-md-12">
            <div class="card mb-4">
               <div class="card-header"><i class="fa fa-chart-bar mr-1"></i>Mandal List
...
<script type="text/javascript">
   $(document).ready(function(){
    paramData = {'act':'searchMandal','filter_by':'all' }; 
    ajax({
         a: "mandalajax",
         b: paramData,
         c:function(){},
    ...
    $('#inputvalue').keyup(function() {
           var filter_by = $(this).val();
             paramData = {'act':'searchMandal','filter_by':filter_by }; 
               ajax({
                  a:"mandalajax",
                  b:paramData,
                  c:function(){},
