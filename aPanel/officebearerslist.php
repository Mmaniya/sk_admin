   ...
   <tbody>
      <?php
         ...
         foreach($ListingParentCatListArr as $key=>$value) {
             ?>	
      <tr>
         <td><a href="officebearerstable.php?obid=<?php  echo $value->id; ?>"><?php  echo $value->person_name; ?></a></td>
      </tr>
      <?php } 
         } else { ?>
      <tr>
...
<script>	
   ...
   paramData = {'act':'parentCategoryListpagination','page':page,'filterby':value }; 
   $.ajax({
   	type: "POST",
