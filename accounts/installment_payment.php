...
<form id="payment_form">
 <input name="ptype" value="installment" type="hidden">
 <input name="client_id" value="<?php echo $rsInstallment->client_id;?>" type="hidden">
 <input name="invoice_id" value="<?php echo $invoiceId;?>" type="hidden">
 ...
 <input type="hidden" name="installment_id" value="<?php echo $installmentId?>" />
  <input type="hidden" name="itemName" value="Installment for BPE Invoice:<?php echo $invoiceId."::".$invoiceServices['services']['email_subject']?>" />
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="clientZip" value="<?php echo $clientZip?>">
	     ...
	     <div class="col-sm-6 right-column" style="background-color:#f4f6f6">	 
		  <h5><span> <i class="fa fa-shopping-cart text-primary" aria-hidden="true"></i>  &nbsp; &nbsp; Installment Payment</span></h5>
		  
		  
		  <ul class="payment-summary">
         
            <li class="text-primary" style="font-size:22px;"><strong>TOTAL</strong>	 <span><strong><?php echo money($rsInstallment->amount,'$');?></strong></span></li>	
          <input type="hidden" name="finalAmountVal" value="<?php echo $rsInstallment->amount;?>">
        ...
        <?php         if( $isInstallment =='Y') { ?>
		   ...
		   if($V['installment_id']!=$installmentId) {
		   ?>
  ...
  <form id="submitFrm" action="installment_thankyou.php" method="post">
