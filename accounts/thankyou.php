       ...
       <div  width="580" style="margin:auto;display:table;"> 
         ...
         <div style="padding-top:30px;">
		   ...
		   <div style="padding:0cm 0cm 21.0px 0cm">
             <p style="line-height:21.5px"><span style="color:#000">Thank you for shopping with  us! Your transaction with BizPlanEasy was successful.</span></p>
           </div>
		  ...
		  <span style="color:#000;width:60%">Order Amount </span> <span style="float:right;color:#000;width:40%;border-left: 1px solid #eee;padding-left: 5px;">[ORDER_AMOUNT]</span> </li>
