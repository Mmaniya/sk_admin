 ...
 <h5 class="card-header warning-text text-left bg-primary text-white">TKE-<?php echo $rsTicket->id; ?> - <?php echo $rsTicket->subject; ?>   <small class="float-right"><?php echo date('m/d/Y h:i:s a',strtotime($rsTicket->added_date)); ?></small> </h5>
  ...
  <div class="card">     
         <div class="card-body">
		   ...
		   <!-- <h5><?php echo  $rsTicket->subject;?></h5>--->
			<p><?php echo $rsCategory->category_name.' <br/> - '.getTimeAgo(strtotime($rsTicket->added_date)); ?> <span class="float-right"><?php echo date('m/d/Y h:i:s a',strtotime($rsTicket->added_date)); ?></span> </p>
 ...
 $senderName = $rsUser->contact_fname.' '.$rsUser->contact_lname;
	...
	?>
     ...
     <div class="card" style="margin-top:20px">     
         <div class="card-body">
		     <div class="ticket_list_reply"> 		  
		    <h5><?php echo  $senderName.' - <small>'.getTimeAgo(strtotime($val->added_date));?></small>   <small class="float-right"><?php echo date('m/d/Y h:i:s a',strtotime($val->added_date)); ?></small></h5>  <hr/>
